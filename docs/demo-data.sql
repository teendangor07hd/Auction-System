...
VALUES
    ...
    -- auc-001: MacBook Pro M3 Max - Ends May 25, 2026. 50 bids.
    (
        'auc-001', 'i-elec-01', '2026-05-18T10:00:00', '2026-05-25T18:00:00',
        60000000.0, 85500000.0, 'u-bid-03', 'RUNNING', 500000.0,
        '2026-05-15T00:00:00', '2026-05-19T15:20:00'
    ),
...
VALUES
    -- Bids for auc-001 (MacBook Pro M3 Max) - 50 bids
    ('bid-tx-auc1-001', 'auc-001', 'u-bid-01', 60500000.0, '2026-05-18T10:05:00'),
    ('bid-tx-auc1-002', 'auc-001', 'u-bid-02', 61000000.0, '2026-05-18T10:15:00'),
    ('bid-tx-auc1-003', 'auc-001', 'u-bid-03', 61500000.0, '2026-05-18T10:30:00'),
    ('bid-tx-auc1-004', 'auc-001', 'u-bid-04', 62000000.0, '2026-05-18T10:45:00'),
    ('bid-tx-auc1-005', 'auc-001', 'u-bid-05', 62500000.0, '2026-05-18T11:00:00'),
    ('bid-tx-auc1-006', 'auc-001', 'u-bid-01', 63000000.0, '2026-05-18T11:15:00'),
    ('bid-tx-auc1-007', 'auc-001', 'u-bid-02', 63500000.0, '2026-05-18T11:30:00'),
    ('bid-tx-auc1-008', 'auc-001', 'u-bid-03', 64000000.0, '2026-05-18T11:45:00'),
    ('bid-tx-auc1-009', 'auc-001', 'u-bid-04', 64500000.0, '2026-05-18T12:00:00'),
    ('bid-tx-auc1-010', 'auc-001', 'u-bid-05', 65000000.0, '2026-05-18T12:15:00'),
    ('bid-tx-auc1-011', 'auc-001', 'u-bid-01', 65500000.0, '2026-05-18T12:30:00'),
    ('bid-tx-auc1-012', 'auc-001', 'u-bid-02', 66000000.0, '2026-05-18T12:45:00'),
    ('bid-tx-auc1-013', 'auc-001', 'u-bid-03', 66500000.0, '2026-05-18T13:00:00'),
    ('bid-tx-auc1-014', 'auc-001', 'u-bid-04', 67000000.0, '2026-05-18T13:15:00'),
    ('bid-tx-auc1-015', 'auc-001', 'u-bid-05', 67500000.0, '2026-05-18T13:30:00'),
    ('bid-tx-auc1-016', 'auc-001', 'u-bid-01', 68000000.0, '2026-05-18T13:45:00'),
    ('bid-tx-auc1-017', 'auc-001', 'u-bid-02', 68500000.0, '2026-05-18T14:00:00'),
    ('bid-tx-auc1-018', 'auc-001', 'u-bid-03', 69000000.0, '2026-05-18T14:15:00'),
    ('bid-tx-auc1-019', 'auc-001', 'u-bid-04', 69500000.0, '2026-05-18T14:30:00'),
    ('bid-tx-auc1-020', 'auc-001', 'u-bid-05', 70000000.0, '2026-05-18T14:45:00'),
    ('bid-tx-auc1-021', 'auc-001', 'u-bid-01', 70500000.0, '2026-05-18T15:00:00'),
    ('bid-tx-auc1-022', 'auc-001', 'u-bid-02', 71000000.0, '2026-05-18T15:15:00'),
    ('bid-tx-auc1-023', 'auc-001', 'u-bid-03', 71500000.0, '2026-05-18T15:30:00'),
    ('bid-tx-auc1-024', 'auc-001', 'u-bid-04', 72000000.0, '2026-05-18T15:45:00'),
    ('bid-tx-auc1-025', 'auc-001', 'u-bid-05', 72500000.0, '2026-05-18T16:00:00'),
    ('bid-tx-auc1-026', 'auc-001', 'u-bid-01', 73000000.0, '2026-05-18T16:15:00'),
    ('bid-tx-auc1-027', 'auc-001', 'u-bid-02', 73500000.0, '2026-05-18T16:30:00'),
    ('bid-tx-auc1-028', 'auc-001', 'u-bid-03', 74000000.0, '2026-05-18T16:45:00'),
    ('bid-tx-auc1-029', 'auc-001', 'u-bid-04', 74500000.0, '2026-05-18T17:00:00'),
    ('bid-tx-auc1-030', 'auc-001', 'u-bid-05', 75000000.0, '2026-05-18T17:15:00'),
    ('bid-tx-auc1-031', 'auc-001', 'u-bid-01', 75500000.0, '2026-05-19T09:00:00'),
    ('bid-tx-auc1-032', 'auc-001', 'u-bid-02', 76000000.0, '2026-05-19T09:15:00'),
    ('bid-tx-auc1-033', 'auc-001', 'u-bid-03', 76500000.0, '2026-05-19T09:30:00'),
    ('bid-tx-auc1-034', 'auc-001', 'u-bid-04', 77000000.0, '2026-05-19T09:45:00'),
    ('bid-tx-auc1-035', 'auc-001', 'u-bid-05', 77500000.0, '2026-05-19T10:00:00'),
    ('bid-tx-auc1-036', 'auc-001', 'u-bid-01', 78000000.0, '2026-05-19T10:15:00'),
    ('bid-tx-auc1-037', 'auc-001', 'u-bid-02', 78500000.0, '2026-05-19T10:30:00'),
    ('bid-tx-auc1-038', 'auc-001', 'u-bid-03', 79000000.0, '2026-05-19T10:45:00'),
    ('bid-tx-auc1-039', 'auc-001', 'u-bid-04', 79500000.0, '2026-05-19T11:00:00'),
    ('bid-tx-auc1-040', 'auc-001', 'u-bid-05', 80000000.0, '2026-05-19T11:15:00'),
    ('bid-tx-auc1-041', 'auc-001', 'u-bid-01', 80500000.0, '2026-05-19T13:00:00'),
    ('bid-tx-auc1-042', 'auc-001', 'u-bid-02', 81000000.0, '2026-05-19T13:15:00'),
    ('bid-tx-auc1-043', 'auc-001', 'u-bid-03', 81500000.0, '2026-05-19T13:30:00'),
    ('bid-tx-auc1-044', 'auc-001', 'u-bid-04', 82000000.0, '2026-05-19T13:45:00'),
    ('bid-tx-auc1-045', 'auc-001', 'u-bid-05', 82500000.0, '2026-05-19T14:00:00'),
    ('bid-tx-auc1-046', 'auc-001', 'u-bid-01', 83000000.0, '2026-05-19T14:15:00'),
    ('bid-tx-auc1-047', 'auc-001', 'u-bid-02', 83500000.0, '2026-05-19T14:30:00'),
    ('bid-tx-auc1-048', 'auc-001', 'u-bid-03', 84000000.0, '2026-05-19T14:45:00'),
    ('bid-tx-auc1-049', 'auc-001', 'u-bid-04', 84500000.0, '2026-05-19T15:00:00'),
    ('bid-tx-auc1-050', 'auc-001', 'u-bid-03', 85500000.0, '2026-05-19T15:20:00'),
