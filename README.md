...
### Chi tiết Phiên đấu giá (Realtime Tracking)
Giao diện theo dõi diễn biến phiên đấu giá với biểu đồ giá trực quan và bảng xếp hạng người đặt giá (Leaderboard) được cập nhật liên tục.
![Chi tiết Phiên đấu giá](docs/images/auction_detail.png)
